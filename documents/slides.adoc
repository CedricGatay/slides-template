...
[source,java]
-----
include::samples/servlet/src/main/java/com/codetroopers/eput/domain/entities/User.java[tags=class]
-----
...
[source,java]
-----
include::samples/servlet/src/main/java/com/codetroopers/eput/MyServlet.java[tags=post]
-----
...
[source,jsp]
-----
include::samples/servlet/src/main/webapp/helloWorld.jsp[tags=jsp]
-----
