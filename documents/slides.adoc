...
[cols="^.^a,^.^a"]
|===
| Wildfly image:wildfly.png[width=150px]
| Glassfish image:glassfish.png[width=150px]
...
[cols="^.^a,^.^a"]
|===
| Github image:github.png[width=150px]
| Apache image:apache.png[width=150px]
| Eclipse image:eclipse.png[width=150px]
| Codehaus image:codehaus.png[width=150px]
|===
...
| Hibernate image:hibernate.png[width=150px]
| AspectJ image:aspectj.png[width=150px]
