...
[.section_link]
http://vm.docker:9080/tpjavaee/helloWorld.jsp
...
GET/POST http://vm.docker:9080/tpjavaee/ws/users?name=aeaze&email=qsd@qsd.fr
...
<2> Chemin de réponse
<3> Type de données créé par le webservice
...
A voir simplement en action là : http://vm.docker:9080/tpjavaee/
